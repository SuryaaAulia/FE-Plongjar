...
@Component({
  ...
  templateUrl: './list-ketua-kk.component.html',
  styleUrls: ['./list-ketua-kk.component.scss'],
})

export class ListKetuaKkComponent implements OnInit, OnDestroy {
  ...
  tableColumns: TableColumn<Lecturer>[] = [
    ...
    { key: 'nip', header: 'NIP' },
    { key: 'kelompokKeahlian', header: 'Kelompok Keahlian', width: 'col-bidang-keahlian' },
